<x-layout title_page="Inicio FB">
  <!-- SOBRE NOSOTROS -->
  <div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
    <img src="about.jpg" alt="about" class="absolute inset-0 -z-10 w-full h-5/6 object-cover object-right md:object-center">
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8 bg-black bg-opacity-50 rounded-2xl">    
      <div class="mx-auto max-w-2xl lg:mx-0">
        <h2 class="text-5xl font-semibold tracking-tight text-white sm:text-7xl">Sobre nosotros</h2>
        <p class="mt-8 text-pretty text-lg font-medium text-white sm:text-xl/8">Informacion de la empresa.</p>
      </div>
